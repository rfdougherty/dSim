...
void SpinRenderer::setPositions(float *pos, int numSpins)
{
	...
	//printf("(Inside SpinRenderer::setPositions): Positions have been set!\n");
}
...
void SpinRenderer::setVertexBuffer(unsigned int vbo, int numSpins)
{
	...
	//printf("(Inside SpinRenderer::setVertexBuffer): Vbo has been set! vbo: %u.\n", vbo);
}
...
void SpinRenderer::_drawPoints()
{
	...
	//printf("Drawing points with m_vbo!\n");
    }
}
